...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.discussion_boards_organization =
      await organizations.getDiscussion_boards_organization({
        transaction,
      });

    output.enrollments_organization =
      await organizations.getEnrollments_organization({
        transaction,
      });

    output.instructors_organization =
      await organizations.getInstructors_organization({
        transaction,
      });
    ...
    output.students_organization = await organizations.getStudents_organization(
      {
        transaction,
      },
    );
